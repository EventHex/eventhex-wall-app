...
export default function RightSidebar({
  ...
  return (
    <>
      ...
      />
      <div className="w-full h-screen py-[22px] overflow-y-auto no-scrollbar">
        {/* Header */}
          ...
          <div className="flex flex-col gap-[32px] px-4 ">
            ...
            <div className=" flex flex-col gap-[28px] px-12">
              <div className="flex flex-col justify-center items-center">
                <h1 className=" text-[18px] text-center font-[700]">
                  {titleText}
                </h1>
                <p className="text-[#B1B1B1]    text-center text-[14px] font-[500]">
                  ...
                  <div className="relative border border-[#C7D0FF96] rounded-[35px] backdrop-blur-md p-6">
                    ...
                    <div className="mb-4 p-3 bg-blue-50/80 rounded-xl border border-blue-200/50">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[12px] font-[600] text-blue-700 uppercase tracking-wide">
                          Current Session
                        </span>
                      </div>
                      <h4 className="text-[14px] font-[600] text-blue-800 mb-1">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-[18px] font-[600] text-emerald-700">
                          Live Takeaways
                        </h3>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    liveTakeaways.takeaways.length > 0 ? (
                      <div className="space-y-3 max-h-[300px] overflow-y-auto">
                        {liveTakeaways.takeaways.map((takeaway, idx) => (
                          <div
                            key={idx}
                            className="bg-white/80 rounded-xl p-3 border border-emerald-200/50"
                          >
                            <h4 className="text-[14px] font-[600] text-emerald-800 mb-2">
                              {takeaway.heading}
                            </h4>
                              ...
                              takeaway.hashtags.length > 0 && (
                                <div className="flex flex-wrap gap-1 mt-2">
                                  {takeaway.hashtags.map((tag, tagIdx) => (
                                    <span
                                      key={tagIdx}
                                      className="inline-flex items-center px-2 py-1 rounded-full text-[10px] font-medium bg-emerald-100 text-emerald-800"
                                    >
                                      {tag}
                                    </span>
                                  ))}
                ...
                <div className="relative">
                  ...
                  <div className="relative border border-[#C7D0FF96] rounded-[35px] backdrop-blur-md p-6">
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-[16px] font-[600] text-slate-600 mb-2">
                        No Session Selected
                      </h3>
                      <p className="text-[12px] text-slate-500">
                        Click the settings button to select a session and view
                        live takeaways
                      </p>
                    </div>
                  </div>
